...
import { Button, Modal, Input, Select, Textarea, Stack } from "@/components/ui";
...
export function PostInternshipButton({
  employerProfile,
}: {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      alert(err instanceof Error ? err.message : "Failed to create internship");
    } finally {
      setCreating(false);
    }
  };
